...
GpuSlabHashContext<KeyT, ValueT, SlabHashTypeT::ConcurrentMap>::searchKey(
    bool& to_be_searched, const uint32_t& laneId, const KeyT& myKey,
    ValueT& myValue, const uint32_t bucket_id) {
...
GpuSlabHashContext<KeyT, ValueT, SlabHashTypeT::ConcurrentMap>::searchKeyBulk(
    const uint32_t& laneId, const KeyT& myKey, ValueT& myValue,
